...
class ResponseBuilder {
  ...
  _buildSimpleReject(hon, results, ch) {
    if (ch === 'kakao') {
      return `${hon}, 해당 정보는 보안 및 정책상 제공이 어렵습니다 🙏\n제품·주문·배송 관련 문의는 언제든지 도와드릴게요!`;
    }
    return [
      `${hon}, 해당 정보는 보안 및 정책상 제공이 어렵습니다.`,
      '',
      '임원·직원 개인 연락처, 내부 자료 등은 안내드리기 어려운 점 양해 부탁드립니다.',
      '제품·주문·배송·교환·환불 관련 문의는 언제든지 도와드릴게요! 😊',
    ].join('\n');
  }
